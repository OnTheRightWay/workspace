...
<table border="0" cellspacing="0" cellpadding="0"  class="wukuang"width="100%">
  <tr>
    ...
    <td width="57%"align="right">
    	<%--添加职务 --%>
       <a href="<s:url action="postAction_toEdit?postId="/>">
...
<table width="100%" border="1" >
  ...
  <tr class="henglan" style="font-weight:bold;">
    ...
    <s:set var="i" value="0"/>
  <s:iterator value="%{#request.pageBean.lists}" var="post">
      ...
      <s:if test="%{i%2==0}">
          <tr class="tabtd2">
              ...
              <td width="7%" align="center">
                  <a href="<s:url action="postAction_toEdit?postId=%{#post.postId}"/> "><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>
              </td>
          </tr>
      </s:if>
      <s:else>
          <tr class="tabtd1">
              <td align="center"><s:property value="#post.deparment.depName"/></td>
              <td align="center"><s:property value="#post.postName"/></td>
              <td width="7%" align="center">
                  <a href="<s:url action="postAction_toEdit?postId=%{#post.postId}"/>"><img src="${pageContext.request.contextPath}/images/button/modify.gif" class="img" /></a>
              </td>
 ...
 <table border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <c:if test="${pageBean!=null}">
        ...
        <c:if test="${requestScope.pageBean.currentPage > 1}">
            <a href="postAction_findAllByPage.action?pc=${requestScope.pageBean.currentPage - 1}${requestScope.pageBean.param}">上一页</a>
        </c:if>
        <c:forEach end="${end}" begin="${begin}" var="v">

        <a href="postAction_findAllByPage.action?pc=${v}${requestScope.pageBean.param}">
        ...
        <c:if test="${requestScope.pageBean.currentPage < requestScope.pageBean.totalPage}">
            <a href="postAction_findAllByPage.action?pc=${requestScope.pageBean.currentPage + 1}${requestScope.pageBean.param}">下一页</a>
        </c:if>
    </c:if>
            <a href="postAction_findAllByPage.action?pc=${requestScope.pageBean.totalPage}">[尾页]</a>
        </span>
         </td>
     </tr>
 </table>
