	...
	<table border="0" width="1140px" cellspacing="0" cellpadding="0" id="table1" >
		...
		<tr align="center" >
			...
			<td class="login_msg" width="400">
				<form action="<s:url value="staffAction_login.action"/>" method="post">
					...
					<br/>
					<font color="#ff0000">
						<s:property value="#request.login"/>
						<s:fielderror fieldName="login"/>
					</font> 
					<br/>
					用户名：<input type="text" name="loginName" class="msg" value="<s:property value="#request.staff.loginName"/>"/><br/><br/>
					密&nbsp;码：<input type="password" name="loginPwd" class="msg" value="<s:property value="#request.staff.loginPwd"/>"/><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
