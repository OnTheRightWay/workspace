...
<div class="dtree">
	<script type="text/javascript">
		...
		d.add('010301','0103','班级管理','<s:url value="classesAction_findAllByPage.action?pc=1"/>','','right');
		d.add('010302','0103','课程类别','<s:url value="courseTypeAction_findAllByPage.action?pc=1"/> ','','right');
		d.add('0104','01','就业部');
		d.add('010401','0104','就业情况','${pageContext.request.contextPath}/pages/graduate/listGraduate.jsp','','right');
		d.add('0105','01','人力资源部');
		d.add('010501','0105','部门管理','<s:url action="departmentAction_findAllByPage?pc=1"/>','','right');
		d.add('010502','0105','职务管理','<s:url action="postAction_findAllByPage?pc=1"/>','','right');
		d.add('010503','0105','员工管理','<s:url value="staffAction_findAllStaffItem.action"/> ','','right');
