...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="main">
            ...
            <form action="${pageContext.request.contextPath}/service/modify" method="post" class="main_form">
                <!--必填项-->
                <div class="text_info clearfix"><span>业务账号ID：</span></div>
                <div class="input_info">
                    <input type="text" value="${service.serviceId}" name="serviceId" readonly class="readonly" />
                </div>
                    ...
                    <select name="costId">
                        <c:forEach items="${costs}" var="cost">
                            <option value="${cost.costId}"
                                <c:if test="${cost.costId == service.costId}">
                                    selected
                                </c:if>
                            >${cost.name}</option>
                        </c:forEach>
