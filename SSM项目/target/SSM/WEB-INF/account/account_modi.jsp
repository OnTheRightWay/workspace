...
<div id="main">
    ...
    <form action="${pageContext.request.contextPath}/account/updateAccount" method="post" class="main_form">
        <!--必填项-->
        ...
        <div class="input_info">
            <input type="text" value="${idcardNo}" name="recommenderIdCard"/>
            <div class="validate_msg_long error_msgs">正确的身份证号码格式</div>
        </div>
        <div class="text_info clearfix"><span>生日：</span></div>
        <div class="input_info">
            <input type="text" value="<f:formatDate value="${account.birthdate}" type="date"/>" readonly class="readonly" name="birthdate"/>
        </div>
