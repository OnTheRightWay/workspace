package com.lanou.demo3_initAdestroy.config;
...
//指定资源文件的路径
@PropertySource("classpath:com/lanou/demo3_initAdestroy/show.properties")
public class ELConfig {
    ...
    //4、注入其他bean的属性
    @Value("#{defaultScopeService.another}")
    private String fromAnother;

    //5、注入文件资源
    @Value("classpath:com/lanou/demo3_initAdestroy/show.txt")
    ...
    //若要使用value注入，则需要搭配如下静态方法
    public static PropertySourcesPlaceholderConfigurer placeholderConfigurer(){
        return new PropertySourcesPlaceholderConfigurer();
    }

    //注入资源后，也可以在environment对象中获得资源文件中的内容
    @Autowired
